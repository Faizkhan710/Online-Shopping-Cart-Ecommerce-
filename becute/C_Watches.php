                    ...
                    <div class="price__filter--form__inner mb-15 d-flex align-items-center">
                        <div class="price__filter--group">
                            ...
                            <div class="price__filter--input border-radius-5 d-flex align-items-center">
                                ...
                                <input class="price__filter--input__field border-0" name="filter.v.price.gte" id="Filter-Price-GTE1" type="number" placeholder="0" min="0" max="250.00">
                            </div>
                        </div>
                        ...
                        <div class="price__filter--group">
                            ...
                            <div class="price__filter--input border-radius-5 d-flex align-items-center">
                                <span class="price__filter--currency">$</span>
                                <input class="price__filter--input__field border-0" name="filter.v.price.lte" id="Filter-Price-LTE1" type="number" min="0" placeholder="250.00" max="250.00"> 
                            </div>	
                        </div>
                    </div>
                        ...
                        <nav class="header__menu--navigation">
                            <ul class="header__menu--wrapper d-flex">
                                ...
                                <li class="header__menu--items mega__menu--items">
                                    <a class="header__menu--link active" href="shop.php">Shop 
            ...
            <div class="minicart__product">
                <div class="minicart__product--items d-flex">
                    ...
                    <div class="minicart__text">
                        <h4 class="minicart__subtitle"><a href="product-details.html">Z 7-7mm Button is </a></h4>
                ...
                <div class="minicart__product--items d-flex">
                    ...
                    <div class="minicart__text">
                        <h4 class="minicart__subtitle"><a href="product-details.html">Z 7-9mm Button is
                           </a></h4>
                ...
                <div class="shop__collection--column5 swiper">
                    <div class="swiper-wrapper">
                            <?php
                               ...
                               $squery="SELECT * FROM  `category` order by category";
                        ...
                        <div class="swiper-slide">
                            <div class="shop__collection--card text-center">
                                ...
                                <img src="data:image/jpg;base64,<?php echo base64_encode($row['picture']);?>" alt="Category">
                                    <h3 class="shop__collection--title"><?php echo $row['category'];?></h3>
...
$squery="SELECT * FROM  `category` order by category limit 5";
$sresult=mysqli_query($conn,$squery);
if(!$sresult)
{
echo "<script>alert('Error : ".mysqli_error($conn)."');</script>";
...
?>
                                    <li class="widget__categories--menu__list">
                                        <label class="widget__categories--menu__label d-flex align-items-center">
                                            <img class="widget__categories--menu__img" src="assets/img/product/small-product/product1.webp" alt="categories-img">
                                            <h3 class="shop__collection--title"></h3>
                                            <span class="widget__categories--menu__text"><?php echo $row['category'];?></span>
                                            <!-- <svg class="widget__categories--menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394">
                                                <path  d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                                            </svg> -->
                                        </label>
                            ...
                            <div class="single__widget widget__bg">
                                ...
                                <div class="shop__sidebar--product">
                                              ...
                                              $squery="SELECT * FROM  `product_add1` limit 4 ";
                                                 $sresult=mysqli_query($conn,$squery);
                                              if(!$sresult)
                                                   {
                                                  echo "<script>alert('Error : ".mysqli_error($conn)."');</script>";
                                    ...
                                    <div class="small__product--card d-flex">
                                        <div class="small__product--thumbnail">
                                            ...
                                            <img src="data:image/jpg;base64,<?php echo base64_encode($row['Product_Pic']);?>" alt="product">
                                            </a>
                                        </div>
                                        <div class="small__product--content">
                                            <h3 class="small__product--card__title"><a href="product-details.html"><?php echo $row['Product_Name'];?> </a></h3>
                                            <div class="small__product--card__price mb_5">
                                                <span class="current__price"><?php echo $row['Dprice'];?></span>
                                            </div>
                                            <ul class="rating small__product--rating d-flex">
                                                <li class="rating__list">
                                                    <span class="rating__icon">
...
$squery="SELECT * FROM `product_add1` JOIN `category` on product_add1.PCategory = category.Service_Id WHERE PCategory=18;
";
$sresult=mysqli_query($conn,$squery);
if(!$sresult)
{
...
<?php  while($row=mysqli_fetch_assoc($sresult))
 ...
 ?>
                                        ...
                                        <p><a href="login.php" name="add" role="button" class="product__card--btn">Buy Now
                                        <?php
                                        }
                                        else{
                                        ...
                                        ?>
                                                    ...
                                                    <div class="product__card--content text-center">
                                                        ...
                                                        <h3 class="product__card--title"><a href="product-details.html"><?php echo $row['Product_Name'];?></a></h3>
                                                        <div class="product__card--price">
                                                            <span class="current__price"><?php echo $row['Dprice'];?></span>
                                                            <span class="old__price"><?php echo $row['Fprice'];?></span>
                                                        </div>  
                                                    </div>
                                                </article>
                                            </div>
...
$squery="SELECT * FROM `product_add1` JOIN `category` on product_add1.PCategory = category.Service_Id limit 8";
$sresult=mysqli_query($conn,$squery);
if(!$sresult)
{
echo "<script>alert('Error : ".mysqli_error($conn)."');</script>";
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__card product__list d-flex align-items-center">
                                                    <div class="product__card--thumbnail product__list--thumbnail">
                                                        <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                                        <img class="product__card--thumbnail__img product__primary--img" src="data:image/jpg;base64,<?php echo base64_encode($row['Product_Pic']);?>" alt="Product">
                                                            <img class="product__card--thumbnail__img product__secondary--img" src="assets/img/product/main-product/product2.webp" alt="product-img"> 
                                                        </a>
                                                        <span class="product__badge">-14%</span>
                                                        <ul class="product__card--action">
                                                    ...
                                                    <div class="product__card--content product__list--content">
                                                        ...
                                                        <p class="product__card--content__desc mb-15"><?php echo $row['Product_des'];?></p>
...
$squery="SELECT * FROM `product_add1` JOIN `category` on product_add1.PCategory = category.Service_Id ";
$sresult=mysqli_query($conn,$squery);
if(!$sresult)
{
echo "<script>alert('Error : ".mysqli_error($conn)."');</script>";
...
<?php  while($row=mysqli_fetch_assoc($sresult))
 ...
 ?>
                            <form action="#">
                                <h2 class="product__details--info__title mb-15"><?php echo $row['Product_Name'];?></h2>
                                ...
                                <p class="product__details--info__desc mb-15"><?php echo $row['Product_des'];?></p>
