    ...
    <header class="header__section">
                ...
                <div class="main__header--inner d-flex justify-content-between align-items-center">
                        ...
                        <nav class="header__menu--navigation">
                            <ul class="header__menu--wrapper d-flex">
                                <li class="header__menu--items">
                                    <a class="header__menu--link active" href="index.php">Home 
                    ...
                    <div class="header__account">
                        <ul class="header__account--wrapper d-flex align-items-center">
                            ...
                            <li class="header__account--items">
                                <a class="header__account--btn d-sm-2-none" href="http:../Dashboard/auth-signin-cover.php">
                                    <span class="header__account--btn__icon">
        ...
        <div class="predictive__search--box ">
            <div class="predictive__search--box__inner">
                ...
                <form method="post" class="predictive__search--form" action="#">
                    <label>
                  
                
                        <input class="predictive__search--input" name="keyword" placeholder="Search Here" type="text">
                    </label>
                    <button name="search" class="predictive__search--button text-white" aria-label="search button"><svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="30.51" height="25.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"/></svg>  </button>
...
<!-- button -->
                    <a href="Category.php?id=<?php echo $row['Service_Id']; ?>" class="btn btn-danger">
                ...
                <div class="product__section--inner">
                      ...
                      if(!$sresult)
                     {
                      ...
                      <?php  while($row=mysqli_fetch_assoc($sresult))
                       {
                       ?>
                        <div class="col-lg-3 col-md-4 col-sm-6  custom-col mb-30">
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    ...
                                    <img class="product__card--thumbnail__img product__secondary--img" src="data:image/jpg;base64,<?php echo base64_encode($row['ProductImage_1']);?>" alt="Product">
                                    </a>
        ...
        <section class="product__section section--padding ">
            <div class="container">
                <div class="section__heading text-center mb-40">
                    <h2 class="section__heading--maintitle">FEATURING PRODUCT</h2>
                </div>
...
$query="SELECT * FROM `project_info` WHERE `id` ='1'";
                    ...
                    <div class="col-lg-4 col-md-8">
                        <div class="footer__widget">
                            ...
                            <div class="footer__widget--inner">
                                ...
                                <p class="footer__widget--desc"><?php echo $row[2]; ?> </p>
                                <ul class="footer__widget--info">
                                    <li class="footer__widget--info_list">
                                        ...
                                        <span class="footer__widget--info__text"><?php echo $row[3]; ?></span>
                                    </li>
                                    <li class="footer__widget--info_list">
                                        ...
                                        <a class="footer__widget--info__text" href="tel:+1234567898">:<?php echo $row[4]; ?></a>
                                    </li>
                                    <li class="footer__widget--info_list">                                     
                                        ...
                                        <a class="footer__widget--info__text" href="mailto:example@example.com"><?php echo $row[5]; ?></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
