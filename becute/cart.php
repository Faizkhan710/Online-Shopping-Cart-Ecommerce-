<?php
    ...
    $user_id=$_SESSION['id'];
    $user_products_query="select it.Id,it.Product_Name,it.Dprice from productadd_1 ut inner join items it on it.id=ut.item_id where ut.user_id='$user_id'";
                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                       ...
                       while($row=mysqli_fetch_array($user_products_result)){
                         ...
                         ?>
                        <tr>
                            <th><?php echo $counter ?></th><th><?php echo $row['Product_Name']?></th><th><?php echo $row['Dprice']?></th>
