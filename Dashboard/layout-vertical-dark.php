                   ...
                   <div class="dropdown d-inline-block language-switch">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-end pt-0">
                            ...
                            <a class="dropdown-item" href="pages-profile.html"><i class="mdi mdi-account-circle text-muted font-size-16 align-middle me-1"></i> <span class="align-middle">Proe</span></a>
            ...
            <div data-simplebar class="sidebar-menu-scroll">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="layout-vertical-dark.php">
 ...
 -->
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a href="ecommerce-add-product.php" data-key="t-add-product">Add Product</a></li>
                                <li><a href="ecommerce-add-catagory.php" data-key="t-catagory">Add Catagories</a></li>
                              
                                <li><a href="product_view.php" data-key="t-product-detail">Product Detail</a></li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                            <li><a href="projects-create.php" data-key="t-create-new">Project_Information</a></li>
                               <!--  <li><a href="projects-grid.html" data-key="t-p-grid">Projects Grid</a></li>
                                ...
                                <li><a href="projects-overview.php" data-key="t-p-overview">Project Slides</a></li>
